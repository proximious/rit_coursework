...
from week14.recitation.hashtable import *
import random
...
def hash_vehicle(vehicle):
    ...
    """
    return hash(vehicle.year) * hash(vehicle.model)
...
def main():
    ...
    try:
        ...
        simple_list = ['a', 'b', 'c']
        table_key_test(simple_list, 'string')
    ...
    try:
        ...
        simple_tuple = ('1', '2', '3')
        table_key_test(simple_tuple, 'string')
    except TypeError as e:
        print(e)
    ...
    try:
        ...
        new_vehicle = Vehicle('Toyota', ' Camry', 2018)
        table_key_test(new_vehicle, 'string')
