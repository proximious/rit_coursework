...
def kebab_usage():
    ...
    print('calories - the total calories of the given kebab')
    print('vegan - checks whether the kebab is vegan or not')
...
def kebab_calories(kebab, args):
    """
    returns the calories of the total kebab
    :param kebab: current kebab
    :param args: ignored
    :return:
    """
    print('The kebab contains', skewer_calories(kebab.skewer), 'calories.')


def kebab_vegan(kebab, args):
    """
    checks whether the kebab is vegan or not
    :param kebab: current kebab
    :param args: ignored
    :return:
    """
    if skewer_vegan(kebab.skewer):
        print('The kebab is vegan.')
    else:
        print('The kebab is not vegan')
