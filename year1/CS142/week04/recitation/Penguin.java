 ...
 * Animal Farm
 *
 * Penguins are animals with a name who can run and speak, but also swim
 * underwater.  While they swim underwater they eat fish at a rate that is
 * determined by the length of their beaks.
 *
 * @author RIT CS
 */
public class Penguin extends Animal implements Swimmer {
     ...
     */
    public Penguin(int beakLength, String name) {
    ...
    public void dive(int minutes) {
        this.fishEaten += (FISH_EATEN_PER_MINUTE * minutes * 
            this.beakLength);
        this.travel(minutes * 60 * SWIM_SPEED_MS);
    }
