...
namespace PrimeGen
{
    ...
    public class PrimeGen
    {
        ...
        /// </summary>
        /// <returns>Array of BigIntegers</returns>
        public BigInteger[] GeneratePrimes(int bits, int count, List<int> checks)
        {
            BigInteger[] primesList = new BigInteger[count];
            ...
            Parallel.ForEach(InfiniteEnum(), po, (item, state) =>
            {
