...
public class WebServer {
  ...
  public static final String TURN_URL = "/checkTurn";
  ...
  public WebServer(final PlayerLobby playerLobby, final TemplateEngine templateEngine,
                   final GameCenter gameCenter, final Gson gson) {
    // validation
  ...
  public void initialize() {
    ...
    //signs the player in and show the player lobby webpage
    ...
    post(VALIDATE_URL, new PostValidateMoveRoute(gson, gameCenter));

    post(SUBMIT_URL, new PostSubmitTurnRoute(gson, gameCenter));

    post(SIGNOUT_URL, new PostSignOutRoute(playerLobby,gameCenter,templateEngine));
    //Checks if it is currently the users turn
    post(TURN_URL, new PostCheckTurnRoute(gson, gameCenter));
