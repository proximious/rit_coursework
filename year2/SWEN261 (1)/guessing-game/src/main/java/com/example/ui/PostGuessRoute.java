...
public class PostGuessRoute implements Route {
  ...
  static final String NUM_IS_LOWER = "The correct number is less than your guess";
  static final String NUM_IS_HIGHER = "The correct number is greater than your guess";
    ...
    if(playerServices != null) {
      ...
      switch (playerServices.makeGuess(guess)) {
        ...
        case WRONG:
          vm.put(GetGameRoute.GUESSES_LEFT_ATTR, playerServices.guessesLeft());
          String output = "";
          if (playerServices.currentGame().getNumberToGuess() < guess) {
            output = NUM_IS_LOWER;
          } else {
            output = NUM_IS_HIGHER;
          }
          mv = error(vm, BAD_GUESS + output);
          break;
